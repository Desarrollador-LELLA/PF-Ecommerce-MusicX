...
const ProductoCreate = () => {
    ...
    const ValidoProducto = ({ nombre, autor, descripcion, key, Imagen, tiempo, generos, licencias, audio }) => {
      const e = {};
      let valido = true;
      const regex = /^[0-9].*$/;
                ...
                <Card className={`${style.registroProducto} m-auto`}>
                    <Form className="card card-body" onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <div className="form-group input-group input-group-text my-3 d-flex justify-content-between">
                          ...
                          <Form.Select name="genero" className={`${style.selectbox}`} onChange={handlerAgregarGenero} isInvalid={!!errores.generos} >
                            ...
                            <ButtonGroup aria-label="Basic example">
                                {
                                    addGeneros?.map((genero, i) => (
                                        <Button key={i} value={genero} onClick={handlerEliminarGenero} variant="secondary" >
                                            {`${genero} X`}
                                        </Button>
                                    ))
                                }
                        ...
                        <div className="form-group input-group input-group-text my-3 d-flex justify-content-between">
                            ...
                            <Form.Select name="key" className={`${style.selectbox}`} onChange={handleInputChange} isInvalid={!!errores.key} >
                        ...
                        <div className="form-group input-group input-group-text my-3 d-flex justify-content-between">
                            ...
                            <Form.Control type="file" accept="image/png, image/jpg, image/jpeg" onChange={handleSubirImagen} isInvalid={!!errores.imagen} />
                            <br />
                            <Form.Control.Feedback type={"invalid"}>
                                {errores.imagen}
                            </Form.Control.Feedback>
                        ...
                        <div className="form-group input-group input-group-text my-3 d-flex justify-content-between">
                            ...
                            <Form.Control type="file" accept="audio/mp3 , audio/wav" onChange={handleAudio} isInvalid={!!errores.audio} />
                            <Form.Control.Feedback type={"invalid"}>
                                {errores.audio}
                            </Form.Control.Feedback>
                            <br />
                        ...
                        <div className="form-group input-group input-group-text my-3">
                          {
                              loadingPro ?
                              (
                                  <Button className={`${style.button} text-center btn btn-primary`} type="submit" variant="primary" onClick={metodoLuis} >Registrar</Button>
                              )
                              : 
                              (
                                  <div>
